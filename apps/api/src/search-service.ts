...
function mapRankedHome(
  ...
  return {
    ...
    listingStatus: ranked.listing.listingStatus ?? null,
    daysOnMarket: ranked.listing.daysOnMarket ?? null,
    ...
    pricePerSqft: Number(ranked.scoreInputs.pricePerSqft ?? ranked.listing.pricePerSqft ?? 0),
    medianPricePerSqft: Number(ranked.scoreInputs.medianPricePerSqft ?? 0),
    comparableSampleSize: Number(ranked.scoreInputs.comparableSampleSize ?? 0),
